...
def main():
    ...
    target_url_param = "/sites/TribeSquadDashboard-DevTeam/Shared Documents/General/Colective Project/BU.csv"
    ...
    table = 'bu_colective_project'

    uc = ['BU', 'Division']
    data_df = pd.read_csv('BU.csv', usecols=uc)
    data_df.columns = ['BU', 'Division']
    data_df.dropna(inplace=True)
    data_df['met_metric_id'] = 101
    data_df['usr_creator_id'] = 2425
