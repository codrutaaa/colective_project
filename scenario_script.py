...
def main():
    ...
    target_url_param = "/sites/TribeSquadDashboard-DevTeam/Shared Documents/General/Colective Project/Scenario.csv"
    ...
    table = 'scenario_colective_project'

    data_df = pd.read_csv('Scenario.csv')
