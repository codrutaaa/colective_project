...
def main():
    ...
    target_url_param = "/sites/TribeSquadDashboard-DevTeam/Shared Documents/General/Colective Project/Customer.csv"
    ...
    table = 'customer_colective_project'

    data_df = pd.read_csv('Customer.csv')
    ...
    data_df.columns = ['City',	'Country/Region',	'Country',	'State',	'City2',	'Postal Code',	'Customer',	'Name',	'Postal Code2',	'State2']
